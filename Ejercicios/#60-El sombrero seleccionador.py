...
puntos = {'a':1, 'b':2, 'c':3, 'd':4}
total = 0

def pregunta(q,r1,r2,r3,r4):
    print(" ")
    print(q)
    print(" ")
    print(r1)
...
for key, value in preguntas.items():
    respuesta = pregunta(value[0], value[1], value[2], value[3], value[4])
    total += puntos[respuesta]

resultado = casa(total)
print ("Tu casa es... ", resultado)